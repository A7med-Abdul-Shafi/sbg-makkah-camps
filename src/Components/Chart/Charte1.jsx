...
function ChartEwaaa ({ aspect }){
  ...
  useEffect(() => {
    const countMasri = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaaa/egypt`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaaa/yaman`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaaa/pakistan`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaaa/indonesia`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndi = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaaa/india`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countBangladeshi = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaaa/bangladesh`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPhilipini = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaaa/philipin`
        )
        .then((response) => {
