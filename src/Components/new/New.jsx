...
const FILE_SIZE = File.size / 1024 / 1024;
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api.defaults.baseURL}/alameia/projects`).then((res) => {
        setOptions(res.data);
      });
    };
    projects();
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api.defaults.baseURL}/alameia/in_reason`).then((res) => {
  ...
  const addResults = async (e) => {
    ...
    setIsLoadingStart(true);
    await axios
      .post(`${api.defaults.baseURL}/alameia`, addedData)
      .then((response) => {
        Swal.fire({
          position: "center",
          icon: "success",
  ...
  const onSubmit = (data, onSubmitProps) => {
    setIsLoadingStart(true);
    axios
      .post(`${api.defaults.baseURL}/alameia`, data)
      .then((response) => {
  ...
  useEffect(() => {
    const vacantList = async () => {
      setIsLoadingStart(true);
      await axios.get(`${api.defaults.baseURL}/alameia/vacant`).then(async (res) => {
        setVacant(res.data);
  ...
  useEffect(() => {
    const filterList = async () => {
      setIsLoadingStart(true);
      await axios.get(`${api.defaults.baseURL}/alameia/filter`).then(async (res) => {
  ...
  useEffect(() => {
    ...
    const alameiaRoomList = async () => {
      await axios.get(`${api.defaults.baseURL}/alameiarooms/list`).then(async (res) => {
