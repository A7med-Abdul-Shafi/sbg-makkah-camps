...
function InvoiceAlameia() {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/clearday31`).then((response) => {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/indaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/cleardaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/haramain/dues/eamarmaterial/food/clearday31`).then((response) => {
  //             if (monthDays === 30 || monthDays === 28){
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <a href={`${api.defaults.baseURL}/haramain/eamarmaterial/api/file`}>
              <svg
