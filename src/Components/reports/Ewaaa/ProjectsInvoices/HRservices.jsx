...
function InvoiceAlameia() {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/clearday31`).then((response) => {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/hrservices/food/clearday31`).then((response) => {
  //             if (monthDays === 30 || monthDays === 28){
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <a href={`${api.defaults.baseURL}/ewaaa/hrservices/api/file`}>
              <svg
