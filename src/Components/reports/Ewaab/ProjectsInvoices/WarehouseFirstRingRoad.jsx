...
function InvoiceAlameia() {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/clearday31`).then((response) => {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaab/dues/warehousefrr/food/clearday31`).then((response) => {
  //             if (monthDays === 30 || monthDays === 28){
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <a href={`${api.defaults.baseURL}/ewaab/warehousefrr/api/file`}>
              <svg
