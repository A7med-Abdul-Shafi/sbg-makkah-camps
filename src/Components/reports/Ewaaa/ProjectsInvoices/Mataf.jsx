...
function InvoiceAlameia() {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/mataf/clearday31`).then((response) => {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/mataf/food/clearday31`).then((response) => {
  //             if (monthDays === 30 || monthDays === 28){
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <a href={`${api.defaults.baseURL}/ewaaa/mataf/api/file`}>
              <svg
