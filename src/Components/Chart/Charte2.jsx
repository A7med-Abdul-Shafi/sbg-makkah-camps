...
function ChartEwaab({ aspect }){
  ...
  useEffect(() => {
    const countMasri = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaab/egypt`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaab/yaman`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaab/pakistan`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaab/indonesia`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndi = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaab/india`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countBangladeshi = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaab/bangladesh`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPhilipini = async () => {
      axios
        .get(
          `${api.defaults.baseURL}/ewaab/philipin`
        )
        .then((response) => {
