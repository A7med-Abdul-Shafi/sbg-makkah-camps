...
function InvoiceAlameia() {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/cleardaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/clearday31`).then((response) => {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/cleardaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/alameiaconsums/food/clearday31`).then((response) => {
  //             if (monthDays === 30 || monthDays === 28){
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <a href={`${api.defaults.baseURL}/ewaaa/alameiaconsums/api/file`}>
              <svg
