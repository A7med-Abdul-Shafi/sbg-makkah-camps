...
function InvoiceAlameia() {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/dayone`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/dayone1`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/indaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/cleardaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/inday31`
        )
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/clearday31`).then((response) => {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/dayone`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/dayone1`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/indaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/cleardaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/inday31`
        )
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/alameia/dues/servicebuildingssec16/food/clearday31`).then((response) => {
  //             if (monthDays === 30 || monthDays === 28){
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <a
              href={`${api.defaults.baseURL}/alameia/servicebuildingssec16/api/file`}
            >
              <svg
