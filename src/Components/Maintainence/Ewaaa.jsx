...
const userColumns = [
  ...
  const { data, isFetchLoading, isError, refetch } = useQuery(
    ...
    async () => {
      return axios
        .get(
          `${api.defaults.baseURL}/ewaaamaintainence/list`
        )
        .then((res) => res.data);
    }
  );
  ...
  const fetchSearchResults = async (event) => {
    ...
    axios
      .get(
        `${api.defaults.baseURL}/ewaaa/search?q=${query}`
      )
      .then(async (res) => {
        setQuery("");
  ...
  const handleAddRequest = async () => {
    ...
    await axios
      .post(
        `${api.defaults.baseURL}/ewaaa/maintainence/new`,
        addTodo
      )
      .then(async (res) => {
        refetch();
  ...
  const handleDelete = async (id) => {
    ...
    await axios
      .delete(
        `${api.defaults.baseURL}/ewaaamaintainence/delete/${id}`
      )
      .then(async (res) => {
