...
const FILE_SIZE = File.size / 1024 / 1024;
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api.defaults.baseURL}/ewaaa/projects`).then((res) => {
        setOptions(res.data);
      });
    };
    projects();
  ...
  useEffect(() => {
    const projects = async () => {
      await axios.get(`${api.defaults.baseURL}/ewaaa/in_reason`).then((res) => {
  ...
  const addResults = async (e) => {
    ...
    setIsLoading(true);
    await axios
      .post(`${api.defaults.baseURL}/ewaaa`, addedData)
      .then((response) => {
        Swal.fire({
          position: "center",
          icon: "success",
  ...
  const onSubmit = (data, onSubmitProps) => {
    setIsLoading(true);
    axios
      .post(`${api.defaults.baseURL}/ewaaa`, data)
      .then((response) => {
        console.log(data);
  ...
  useEffect(() => {
    ...
    const vacantList = async () => {
      await axios.get(`${api.defaults.baseURL}/ewaaa/vacant`).then(async (res) => {
        setVacant(res.data);
        setIsLoading(false);
      });
    };
  ...
  useEffect(() => {
    ...
    const filterList = async () => {
      await axios.get(`${api.defaults.baseURL}/ewaaa/filter`).then(async (res) => {
  ...
  useEffect(() => {
    ...
    const alameiaRoomList = async () => {
      await axios.get(`${api.defaults.baseURL}/ewaaarooms/list`).then(async (res) => {
