...
function InvoiceAlameia() {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/dayone`)
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/dayone1`)
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/indaytwo`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/cleardaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday3`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday4`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday5`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday6`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday7`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday8`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday9`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday10`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday11`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday12`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday13`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday14`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday15`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday16`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday17`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday18`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday19`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday20`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday21`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday22`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday23`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday24`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday25`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday26`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday27`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday28`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday29`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday30`)
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/inday31`)
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/clearday31`).then((response) => {
  ...
  useEffect(() => {
    const countMasri = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/dayone`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countYamani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/dayone1`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/indaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/cleardaytwo`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday3`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday4`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday5`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday6`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday7`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday8`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday9`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday10`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday11`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday12`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday13`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday14`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday15`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday16`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday17`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday18`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday19`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday20`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday21`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday22`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday23`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday24`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday25`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday26`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday27`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday28`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday29`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countIndonesi = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday30`
        )
        .then((response) => {
  ...
  useEffect(() => {
    const countPakistani = async () => {
      await axios
        .get(
          `${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/inday31`
        )
        .then((response) => {
  ...
  // useEffect(() => {
  //     const countIndonesi = async () => {
  //         await axios.get(`${api.defaults.baseURL}/ewaaa/dues/metalsaudidecoration/food/clearday31`).then((response) => {
  //             if (monthDays === 30 || monthDays === 28){
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <a
              href={`${api.defaults.baseURL}/ewaaa/metalsaudidecoration/api/file`}
            >
              <svg
